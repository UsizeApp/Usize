...
function FilaModal(props) {
  ...
  return (
    ...
    >
      ...
      <TextInput placeholder={`       `} value={values.medida} keyboardType='numeric' maxLength={3} 
      onEndEditing={handleChange(medida)} style={{ textAlign: 'right', color: 'grey', borderBottomWidth: bbw,borderColor: '#ddd' }}>{}</TextInput>
    </View>
    )
}
